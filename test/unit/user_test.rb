...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @valid_user = User.new(:id                => 1                 ,
                           ...
                           :last_name         => 'Suarez'          ,
                           :street_number     => 30                ,
                           :street_name       => 'Cadena de Amor'  ,
                           :district_code     => 'MMLPRN2'         ,
                           :municipality_code => 'PRN'             ,
                           :provincial_code   => 'MML'             ,
                           :voter_id          => 'qwer'            ,
                           :birth_date        => Date.today << 262 ,
                           :email             => 'a@yahoo.com'     ,
                           :voted             => false             ,
                           :activated         => true              )
  end
  ...
  test "check column types" do
    ...
    assert @valid_user.voted.is_a?(FalseClass)
  ...
  test "validity of address" do
    assert @valid_user.complete_address
  ...
  test "user has voted?" do
    assert_equal false, @valid_user.voted?
  end
